...
//Get your API Key (good for 1 hour) 
$loginresponse = callPardotApi('https://pi.pardot.com/api/login/version/3',
    array(
        'email' => 'yukiko.hasegawa+1@salesforce.com',
        'password' => 'Sirena10280125@demo',
        'user_key' => 'f91dd76963613e6bb9e599e1f01d07c5' //available from https://pi.pardot.com/account
    )
);
$xml_login = simplexml_load_string($loginresponse);


//Parameters for ListMembership
$apikey = $xml_login -> api_key;

$listid = $_GET['ListID'];
$created_after = $_GET['CreatedAfter'];
$created_before = $_GET['CreatedBefore'];


//Query ListMembership
$xml = simplexml_load_string(callPardotApi('https://pi.pardot.com/api/listMembership/version/4/do/query',
    array(
        'api_key' => $apikey,
        'user_key' => 'f91dd76963613e6bb9e599e1f01d07c5',
        'list_id' => $listid,
